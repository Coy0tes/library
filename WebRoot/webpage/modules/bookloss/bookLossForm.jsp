...
<body class="hideScroll">
		<form:form id="inputForm" modelAttribute="bookStudentDetail" action="${ctx}/bookloss/bookloss/payBook" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				...
				<tr>
					<td class="width-15 active"><label class="pull-right"><font style="color:red">*</font>赔偿金额：</td>
		   			<td class="width-35" >
