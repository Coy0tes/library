...
<head>
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			// 如果新增图书，图书的在库、借出、遗失、损坏不显示
			if(!$("#id").val()){
				$(".bookother").each(function(){
					{
						$(this).hide();
					}
				});
...
<body class="hideScroll">
		<form:form id="inputForm" modelAttribute="books" action="${ctx}/books/books/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				<tr>
					...
					<td class="width-35">
						<form:input path="isbn" htmlEscape="false" maxlength="13"  class="form-control required" />
					</td>
				</tr>
				<tr>
				...
				<tr class="bookother">
					<td class="width-15 active"><label class="pull-right">在库数量：</label></td>
					<td class="width-35">
						<form:input path="numIn" htmlEscape="false"    class="form-control number"/>
					</td>
		  		</tr>
				<tr class="bookother">
					<td class="width-15 active"><label class="pull-right">借出数量：</label></td>
					<td class="width-35">
						<form:input path="numOut" htmlEscape="false"    class="form-control number"/>
					</td>
		  		</tr>
				<tr class="bookother">
					<td class="width-15 active"><label class="pull-right">遗失数量：</label></td>
					<td class="width-35">
						<form:input path="numLoss" htmlEscape="false"    class="form-control number"/>
					</td>
		  		</tr>
				<tr class="bookother">
					<td class="width-15 active"><label class="pull-right">损坏数量：</label></td>
					<td class="width-35">
						<form:input path="numBroken" htmlEscape="false"    class="form-control number"/>
					</td>
		  		</tr>
		 	</tbody>
		</table>
