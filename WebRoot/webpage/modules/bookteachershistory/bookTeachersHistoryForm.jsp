...
<body class="hideScroll">
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				...
				<tr>
					<td class="width-15 active"><label class="pull-right">教师信息：</label></td>
					<td class="width-35">
						<form:input path="teachersName" htmlEscape="false"    class="form-control "/>
					</td>
					<td class="width-15 active"><label class="pull-right">教师工号：</label></td>
					<td class="width-35">
						<form:input path="teachersBh" htmlEscape="false"    class="form-control "/>
					</td>
				</tr>
				<tr>
