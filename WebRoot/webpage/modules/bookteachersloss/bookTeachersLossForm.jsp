...
<body class="hideScroll">
		<form:form id="inputForm" modelAttribute="bookStudentDetail" action="${ctx}/bookteachersloss/bookteachersloss/payBook" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				...
				<tr>
					<td class="width-15 active"><label class="pull-right"><font style="color:red">*</font>赔偿金额：</label></td>
		   			<td class="width-35" >
		   				<form:input path="pcje" htmlEscape="false"    class="form-control required number"/>
		   			</td>
		  		</tr>
				<%-- <tr>
					...
					<td class="width-35">
						<form:input path="studentnum" htmlEscape="false"    class="form-control "/>
					</td>
				</tr> --%>
		 	</tbody>
		</table>
