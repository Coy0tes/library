...
<body class="hideScroll">
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				...
				<tr>
					<td class="width-15 active"><label class="pull-right"><font color="red">*</font>详细信息：</label></td>
					<td class="width-35">
						<form:textarea path="contents" htmlEscape="false" rows="2"    class="form-control required"/>
					</td>
				</tr>
		 	</tbody>
		</table>
