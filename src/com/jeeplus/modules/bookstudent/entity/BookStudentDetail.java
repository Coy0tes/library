 ...
 * @version 2017-11-08
 */
public class BookStudentDetail extends DataEntity<BookStudentDetail> {
	...
	private String historyid;	// 历史记录的id
	
	
	public BookStudentDetail() {
		super();
	}

	public BookStudentDetail(String id){
		super(id);
	}

	public BookStudentDetail(BookStudent mainid){
		this.mainid = mainid;
	}
	...
	@ExcelField(title="书籍ID", align=2, sort=6)
	...
	@ExcelField(title="书名", align=2, sort=10)
	...
	@ExcelField(title="出版社", align=2, sort=12)
	...
	@ExcelField(title="借出时间", align=2, sort=14)
	...
	@ExcelField(title="应还日期", align=2, sort=15)
	...
	@ExcelField(title="归还时间", align=2, sort=16)
	...
	@ExcelField(title="超期天数", align=2, sort=17)
	...
	@ExcelField(title="学生学号", align=2, sort=1)
	...
	@ExcelField(title="学生姓名", align=2, sort=2)
	...
	@ExcelField(title="操作员", align=2, sort=20)
