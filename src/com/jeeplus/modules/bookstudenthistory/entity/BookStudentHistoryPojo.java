 ...
 * @version 2017-11-10
 */
public class BookStudentHistoryPojo extends DataEntity<BookStudentHistoryPojo> {
	...
	public BookStudentHistoryPojo() {
		super();
	}

	public BookStudentHistoryPojo(String id){
		super(id);
	}
	
	public BookStudentHistoryPojo(BookStudent mainid){
		this.mainid = mainid;
	}
	...
	@ExcelField(title="赔偿时间", align=2, sort=17)
	...
	@ExcelField(title="赔偿金额", align=2, sort=18)
	...
	@ExcelField(title="操作员", align=2, sort=19)
