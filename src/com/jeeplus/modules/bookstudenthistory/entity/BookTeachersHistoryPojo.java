 ...
 * @version 2017-11-10
 */
public class BookTeachersHistoryPojo extends DataEntity<BookTeachersHistoryPojo> {
	...
	public BookTeachersHistoryPojo() {
		super();
	}

	public BookTeachersHistoryPojo(String id){
		super(id);
	}
	
	public BookTeachersHistoryPojo(BookStudent mainid){
		this.mainid = mainid;
	}
	...
	@ExcelField(title="操作员", align=2, sort=17)
